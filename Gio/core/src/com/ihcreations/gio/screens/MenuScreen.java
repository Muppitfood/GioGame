...
public class MenuScreen implements Screen, ControllerListener, InputProcessor{

	final Gio m_game;
	
	OrthographicCamera camera;
	
	public MenuScreen(final Gio game) {
		this.m_game = game;
	...
	public void render(float delta) {
		...
		camera.update();
		m_game.batch.begin();
		m_game.font.draw(m_game.batch, "Play game.", 100, 150);
		m_game.batch.end();
